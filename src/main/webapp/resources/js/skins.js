...
if (location.pathname != "/index-rtl-fa.html" && location.pathname != "/index-rtl-ar.html") {
    if (readCookie("rtl-support")) {
        document.getElementById("beyond-link").setAttribute("href", host + "/resources/css/beyond-rtl.min.css");
        document.getElementById("bootstrap-rtl-link").setAttribute("href", host + "/resources/css/bootstrap-rtl.min.css");
        //Resolve 4095 Issue With IE<=9
        if (getInternetExplorerVersion() <= 9) {
            var a = document.createElement('link');
            a.href = "resources/css/4095-rtl.min.css";
            a.rel = "stylesheet";
            document.getElementsByTagName("head")[0].appendChild(a);
        }
    }
    else {
        document.getElementById("beyond-link").setAttribute("href", host + "/resources/css/beyond.min.css");
        document.getElementById("bootstrap-rtl-link").setAttribute("href", "");
        //Resolve 4095 Issue With IE<=9
        if (getInternetExplorerVersion() <= 9) {
            var a = document.createElement('link');
            a.href = host + "/resources/css/4095.min.css";
            a.rel = "stylesheet";
            document.getElementsByTagName("head")[0].appendChild(a);
        }
    }
