...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/record.css">
<div class="row">
	<div class="col-xs-12 col-md-8">
		<div class="widget-box">
			<div class="widget-header">
				<i class="widget-icon fa fa-arrow-down"></i>
				<h5 class="widget-caption">Record (Annotated record of all users)</h5>
				...
				<div class="widget-main">
					<form method="post">
						<div class="form-group">
							  ...
							  <label for="listUsers">User: </label>
							  <select id="listUsers">
					...
					<button type="button" data-record-text="Loading New Record..." data-loading-text="Updating Concept..." class="btn-blue btn-lg" id="btnUpdatetListConcept">Update</button>
				</div>
			</div>
		</div>
	</div>
...
<script src="${pageContext.request.contextPath}/resources/js/record.js"></script>
